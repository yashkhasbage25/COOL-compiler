...
%class.C = type {	%class.B ,i32 ,i32 ,i32}
%class.Main = type {	%class.Object ,%class.C* ,%class.IO*}
...
if.then0:
	...
	br label %if.else0
if.else0:
	%13 = call %class.IO* @_CN2IO_FN7out_int_(%class.IO* %9, i32 0)
	ret i32 0
}
...
entry:
	...
	store %class.C* null, %class.C** %1, align 4
