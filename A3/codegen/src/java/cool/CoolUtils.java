...
class CoolUtils {
    ...
    public static void PrintMethodsIO(PrintWriter out) {
        out.println("define %class.IO* @_CN2IO_FN10out_string_( %class.IO* %this, i8* %str ) {\n"
                + "entry:\n"
        ...
        out.println("define i8* @_CN2IO_FN9in_string_( %class.IO* %this ) {\n"
                + "entry:\n"
    ...
    public static void PrintMethodsString(PrintWriter out) {
        out.println("define i32 @_CN6String_FN6length_( i8* %this ) {\n"
                + "\tentry:\n"
        ...
        out.println("define i8* @_CN6String_FN6concat_( i8* %this, i8* %that ) {\n"
                + "entry:\n"
        ...
        out.println("define i8* @_CN6String_FN4copy_( i8* %this ) {\n"
                + "entry:\n"
                + "\t%0 = call i8* @malloc( i64 1024 )\n"
                + "\t%retval = bitcast i8* %0 to i8*\n"
        ...
        out.println("define i8* @_CN6String_FN6substr_( i8* %this, i32 %start, i32 %len ) {\n"
                + "entry:\n"
