...
%class.B = type {	%class.A ,i8* ,i8 ,i32 ,i32 ,i32 ,i32}
%class.C = type {	%class.B ,i8* ,i8 ,i32 ,i32 ,i32 ,i32}
...
entry:
	...
	%6 = getelementptr inbounds %class.B, %class.B* %this, i32 0, i32 5
	store i32 0, i32* %6, align 4
	%7 = getelementptr inbounds %class.B, %class.B* %this, i32 0, i32 6
...
entry:
	...
	%1 = bitcast [1 x i8]* @.str6 to i8*
	%2 = getelementptr inbounds %class.C, %class.C* %this, i32 0, i32 1
	store i8* %1, i8** %2, align 4
	%3 = getelementptr inbounds %class.C, %class.C* %this, i32 0, i32 2
	store i8 0, i8* %3, align 4
...
@.str.D = private unnamed_addr constant [2 x i8] c"D\00", align 1
...
@.str5 = private unnamed_addr constant [1 x i8] c"\00", align 1
