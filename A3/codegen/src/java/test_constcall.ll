...
if.then0:
	%2 = bitcast [25 x i8]* @Abortdisvoid to i8*
	%3 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* null, i8* %2)
	call void @exit(i32 1)
	br label %if.else0
if.else0:
	%4 = getelementptr inbounds i32, i32* %0, i32 0, i32 0
...
entry:
	...
	store wrong_expr_type. might be dynamic dispatch, i32* %1, align 4
	ret void
}
