...
%class.Main = type {	%class.IO ,i32 ,i32 ,[1024 x i8]* ,%class.A* ,%class.A* ,[1024 x i8]* ,%class.B* ,%class.A*}
...
entry:
	...
	%3 = bitcast [1 x i8]* @.str0 to [1024 x i8]*
	%4 = getelementptr inbounds %class.Main, %class.Main* %this, i32 0, i32 3
	store [1024 x i8]* %3, [1024 x i8]** %4, align 4
	...
	%8 = getelementptr inbounds %class.Main, %class.Main* %this, i32 0, i32 5
	store %class.A* %7, %class.A** %8, align 4
	%9 = bitcast [1 x i8]* @.str1 to [1024 x i8]*
	%10 = getelementptr inbounds %class.Main, %class.Main* %this, i32 0, i32 6
	store [1024 x i8]* %9, [1024 x i8]** %10, align 4
	%11 = call noalias i8* @malloc(i64 64)
	%12 = bitcast i8* %11 to %class.B*
	call void @_CN1B_FN1B_(%class.B*%12)
	%13 = getelementptr inbounds %class.Main, %class.Main* %this, i32 0, i32 7
	store %class.B* %12, %class.B** %13, align 4
	%14 = getelementptr inbounds %class.Main,%class.Main* %this, i32 0, i32 8
	store %class.A* null, %class.A** %14, align 4
ret void
}
...
entry:
	...
	store %class.A* %2, %class.A** %3, align 4
ret void
}
define i32 @main() {
entry:
